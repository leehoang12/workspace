...
/** Section: EXTERNS ********************************************************/
extern volatile unsigned char hid_report_in1[HID_INT_IN_EP1_SIZE];//YTS
extern volatile unsigned char hid_report_out1[HID_INT_OUT_EP1_SIZE];//YTS
extern volatile unsigned char hid_report_in2[HID_INT_IN_EP2_SIZE];//YTS
extern volatile unsigned char hid_report_out2[HID_INT_OUT_EP2_SIZE];//YTS
...
extern ROM struct{BYTE report[HID_RPT02_SIZE];}hid_rpt02;//YTS
#endif
